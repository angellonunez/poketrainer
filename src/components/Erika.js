    ...
    return (
        <div className='brock'>
            <div className='brock-info'>
                <h2>Leader Erika</h2>
                <p>Erika</p>
                <img src='https://www.serebii.net/pokearth//trainers/frlg/33.png' className='brock-img' />
                <div className='team'>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/071.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/114.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/045.png'/>
