    ...
    return (
        <div className='brock'>
            <div className='brock-info'>
                <h2>Leader Misty</h2>
                <p>Misty is a Gym Leader of Cerulean City's Gym, known officially as the Cerulean Gym. She gives the Cascade Badge to Trainers who defeat her in battle. She specializes in Water-type Pokémon. Misty appears in Pokémon Red, Blue, Yellow, FireRed, and LeafGreen and Let's Go, Pikachu! and Let's Go, Eevee! as the Gym Leader of the Cerulean Gym, which is the second Gym that the player challenges on their journey. Her strategy is an all-out attack with Water-type Pokémon, and she is constantly looking for ways to improve her technique.</p>
                <img src='https://www.serebii.net/pokearth//trainers/frlg/31.png' className='brock-img' />
                <div className='team'>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/120.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/121.png'/>
                ...
                <div className='box'>
                    ...
                    <div className='post'>
                        ...
                        <div className='comment'>
                            <p>Bulbasaur is the best starter against Misty, you can win without problems if you use it. You have the option to catch a Oddish and use the Grass type for the victory!</p>
                        </div>
                    </div>
                </div>
                <div className='box'>
