    ...
    return (
        <div className='brock'>
            <div className='brock-info'>
                <h2>Leader Brock</h2>
                <p>Brock is the Gym Leader of Pewter City's Gym, known officially as the Pewter Gym. He gives the Boulder Badge to Trainers who defeat him in battle. He specializes in Rock-type Pokémon. Brock appears in Pokémon Red, Blue, Yellow, FireRed, and LeafGreen and Pokémon: Let's Go, Pikachu! and Let's Go, Eevee! as the Gym Leader of the Pewter Gym, which is the first Gym that the player challenges on their journey. </p>
                <img src='https://static.wikia.nocookie.net/emile/images/3/3c/278px-FireRed_LeafGreen_Brock.png' className='brock-img' />
                <div className='team'>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/074.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/095.png'/>
