    ...
    return (
        <div className='brock'>
            <div className='brock-info'>
                <h2>Leader Sabrina</h2>
                <p>Sabrina</p>
                <img src='https://www.serebii.net/pokearth//trainers/frlg/35.png' className='brock-img' />
                <div className='team'>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/064.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/122.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/049.png'/>
