    ...
    return (
        <div className='brock'>
            <div className='brock-info'>
                <h2>Leader Lt. Surge</h2>
                <p>Lt. Surge is the Gym Leader of Vermilion City's Gym, known officially as the Vermilion Gym. He hands out the Thunder Badge to Trainers who defeat him. He specializes in Electric-type Pokémon.</p>
                <img src='https://www.serebii.net/pokearth//trainers/frlg/32.png' className='brock-img' />
                <div className='team'>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/100.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/025.png'/>
                    <img src='https://www.serebii.net/pokearth//sprites/frlg/026.png'/>
